...
public class PurchasePage {
    ...
    // Total cost on purchase page - inside <em> within the <p> that contains "Total
    // Cost:"
     ...
     * Used to verify the acceptance criteria: heading must contain "Your flight
     * from".
     *
     ...
     * Used to verify that flight details including total cost are shown on the
     * purchase page.
     *
     ...
     * @param nameOnCard name on card (schema column card_cvv - BlazeDemo uses
     *                   nameOnCard)
     */
