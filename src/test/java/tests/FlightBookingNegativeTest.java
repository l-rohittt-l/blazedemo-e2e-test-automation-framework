...
public class FlightBookingNegativeTest extends BaseTest {
    ...
    /**
     * Negative scenario 1 — clicking "Find Flights" navigates away from the home page.
     *
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class,
          description = "Find Flights navigates to the flights results page (reserve.php)")
     ...
     * validation and navigates to the confirmation page regardless, so the assertion
     * documents this known gap: the confirmation heading IS shown even with no data.
     * Any future addition of form validation that blocks the submission will surface
     * here.
     */
    @Test(retryAnalyzer = RetryAnalyzer.class,
          description = "Empty payment form submitted — confirmation page reached (no AUT validation)")
    public void testEmptyFormSubmission() {
        ...
        // Assert the URL changed away from purchase.php to confirm a page transition occurred.
        WebDriver driver = DriverManager.getDriver();
        String currentUrl = driver.getCurrentUrl();
     ...
     */
    @Test(retryAnalyzer = RetryAnalyzer.class,
          description = "Confirmation heading must not appear on the flights results page")
