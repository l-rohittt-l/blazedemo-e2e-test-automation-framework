...
public class FlightBookingTest extends BaseTest {
    ...
    /**
     * Supplies test data from the source configured by the data.source key in config.properties.
    ...
    public Object[][] bookingData() {
        ...
        switch (source) {
            case "csv":      return CsvDataReader.getData("bookings.csv");
            case "database": return DatabaseDataReader.getData();
            default:         return ExcelDataReader.getData("bookings.xlsx");
        }
    }
